...
function Bubbles(container, self, options) {
    ...
    var addBubble = function(say, posted, reply, live) {
      ...
      if (reply !== "") {
        ...
        bubble.addEventListener("click", function() {
          ...
          socket.emit('fromClient', { client : 'sandeep'});
          socket.on('fromServer', function(data) { // receiving a reply from server.
  ...
  function prepHTML(options) {
    ...
    appendCSS(relative_path + "public/stylesheets/input.css")
    appendCSS(relative_path + "public/stylesheets/reply.css")
    appendCSS(relative_path + "public/stylesheets/says.css")
    appendCSS(relative_path + "public/stylesheets/setup.css")
    appendCSS(relative_path + "public/stylesheets/typing.css")
  }
